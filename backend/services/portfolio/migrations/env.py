"""Alembic migration environment for the Portfolio service."""
...
from app.models import (  # noqa: F401 — registers model metadata
    Portfolio, CASImport, Transaction, NAVCache,
    InvestmentPlan, PlanAllocation, DeploymentEvent, PlanRevisionEvent,
)
...
OWNED_TABLES = {
    "portfolios", "cas_imports", "transactions", "nav_cache",
    "investment_plans", "plan_allocations", "deployment_events", "plan_revision_events",
}
