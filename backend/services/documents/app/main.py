"""Documents service — folder-based document management."""
...
class DocumentsConfig(BaseServiceConfig):
    SERVICE_NAME: str = "pos-documents"
...
async def lifespan(app: FastAPI):
    ...
    await close_db()
    logger.info("Documents service stopped")


app = FastAPI(
    title="pOS Documents Service",
    version="0.1.0",
    lifespan=lifespan,
)
