"""Alembic migration environment for the Watchlist service."""
...
from app.models import (  # noqa: F401 — registers model metadata
    PipelineStage, WatchlistTheme, WatchlistItem, MarketDataCache,
)
...
OWNED_TABLES = {
    "pipeline_stages", "watchlist_themes", "watchlist_items", "market_data_cache",
}
