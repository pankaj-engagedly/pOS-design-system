"""Alembic migration environment for the Photos service."""
...
from app.models import (  # noqa: F401 — registers model metadata
    Photo, Album, AlbumPhoto, PhotoComment,
    Person, PhotoPerson,
)
...
OWNED_TABLES = {
    "photos", "albums", "album_photos", "photo_comments",
    "people", "photo_people",
}
...
def run_migrations_offline():
    ...
    context.configure(
        ...
        literal_binds=True,
        version_table="alembic_version_photos",
