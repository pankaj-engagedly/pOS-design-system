"""Alembic migration environment for the attachment service."""
...
# Only manage tables owned by this service
OWNED_TABLES = {"attachments"}
...
def run_migrations_offline():
    ...
    context.configure(
        ...
        literal_binds=True,
        version_table="alembic_version_attachments",
