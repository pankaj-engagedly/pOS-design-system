"""Alembic migration environment for shared pOS tables (tags, taggables)."""
...
from pos_contracts.models import Tag, Taggable, UserScopedBase  # noqa: F401
