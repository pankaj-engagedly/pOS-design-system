...
- [ ] 12.2 Verify smart views (Inbox, Today, Upcoming, Completed) show correct filtered tasks
- [ ] 12.3 Verify task creation, editing, completion, and list persistence all work end-to-end
