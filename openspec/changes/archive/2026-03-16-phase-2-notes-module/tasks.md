...
- [x] 13.1 Verify gateway proxying end-to-end: create folder, create note, edit content, search, delete, restore
- [x] 13.2 Verify Tiptap works inside Shadow DOM — paste handling, formatting, content round-trip (JSON → editor → JSON)
- [x] 13.3 Test responsive behavior — panels collapse gracefully on narrower viewports
- [x] 13.4 Verify auto-save flow — edit, debounce, save indicator, reload shows saved content
