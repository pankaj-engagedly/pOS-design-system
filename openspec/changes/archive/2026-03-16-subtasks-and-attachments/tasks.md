...
- [x] 7.1 Run `make dev` — verify attachment service starts on port 8003 and responds to health check
- [x] 7.2 Verify file upload, download, and delete work via the gateway
- [x] 7.3 Verify subtask add/toggle/remove works inline in task edit view
- [x] 7.4 Verify subtask progress shows on task rows
- [x] 7.5 Verify attachment upload/display/download/remove works on tasks
